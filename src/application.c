...
#define BATTERY_UPDATE_INTERVAL (1 * HODIN)

#define TMP112_PUB_NO_CHANGE_INTERVAL (5 * MINUT)
#define TMP112_PUB_VALUE_CHANGE 0.1f
#define TMP112_UPDATE_INTERVAL (2 * SEKUND)

#define VOC_LP_TAG_UPDATE_INTERVAL (5 * SEKUND)
#define VOC_LP_TAG_PUB_VALUE_CHANGE 5.0f
#define VOC_LP_TAG_PUB_NO_CHANGE_INTERVAL (5 * MINUT)

#define HUMIDITY_TAG_PUB_NO_CHANGE_INTERVAL (5 * MINUT)
#define HUMIDITY_TAG_PUB_VALUE_CHANGE 5.0f
#define HUMIDITY_TAG_UPDATE_INTERVAL (2 * SEKUND)

#define BAROMETER_TAG_PUB_NO_CHANGE_INTERVAL (5 * MINUT)
#define BAROMETER_TAG_PUB_VALUE_CHANGE 10.0f
#define BAROMETER_TAG_UPDATE_INTERVAL (1 * MINUT)

#define CO2_PUB_NO_CHANGE_INTERVAL (5 * MINUT)
#define CO2_PUB_VALUE_CHANGE 50.0f

#define MAX_PAGE_INDEX 3

#define PAGE_INDEX_MENU -1
#define CO2_UPDATE_INTERVAL (1 * MINUT)
